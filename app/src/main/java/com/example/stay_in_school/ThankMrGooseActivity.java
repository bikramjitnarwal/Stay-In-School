...
public class ThankMrGooseActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thankmrgoose);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            thankmrgooseButtons[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(ThankMrGooseActivity.this, "thank mr goose", Toast.LENGTH_SHORT).show();
                }
            });
